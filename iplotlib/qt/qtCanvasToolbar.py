...
class CanvasToolbar(QToolBar):
    ...
    def __init__(self, parent=None, attach_parent=None, qt_canvas=None):
        ...
        self.qt_canvas: QtPlotCanvas = None
    ...
    def show_preferences(self):
        if self.qt_canvas is not None and self.qt_canvas.get_canvas() is not None:
            self.preferences_window.set_canvas(self.qt_canvas.get_canvas())
